 ...
 * 
 * 1. Call the static method generateARGroupBy() passing a CActiveRecord instance and a string or array of column name(s). The method will return an SQL group string for that CActiveRecord and the specified column name(s).
 * 2. Attach this behavior to a CActiveRecord and call the generateGroupBy() method passing it a string or array of column name(s). 
 ...
 * 3. Attach this behavior to a CActiveRecord and call the groupBy() method passing it a string or array of column name(s). 
